      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 980, margin: "56px auto 0" }}>
        ...
        <div className={shake ? "shake" : ""} style={{ position: "relative" }}>
          <div style={{ position: "absolute", top: -12, left: 24, padding: "0 10px", background: "var(--bg)", zIndex: 2 }}>
            <span className="mono" style={{ fontSize: 14, letterSpacing: ".1em", color: "var(--warn)" }}>
              // 현재의 직무나 전공을 알려주세요
            </span>
          </div>
          <textarea
        ...
        <div style={{ marginTop: 28 }}>
          <div className="mono" style={{ fontSize: 14, color: "var(--warn)", marginBottom: 6, letterSpacing: ".1em" }}>
            // Gemini API 키를 입력하세요
          </div>
          <div style={{ fontSize: 13, color: "var(--paper-2)", opacity: 0.65, marginBottom: 6 }}>
