...
| 역할 | 내용 |
|---|---|
| **분석 엔진** | Gemini API — 직무 텍스트 분석 및 대체 가능성 산출 |
| **프롬프트 설계** | 직무별 특성을 반영한 구조화된 진단 프롬프트 |
| **결과 파싱** | JSON 스키마 기반 응답 파싱 (percent, skillTree, tools, playbook) |
| **개발 도구** | Claude Code로 전체 코드 바이브코딩 |
